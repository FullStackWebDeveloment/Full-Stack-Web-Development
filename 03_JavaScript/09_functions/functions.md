...
console.log(printFullName("Sathish", "Sampath"));
```
...
```js
function greetings(name = "Sathish") {
  let message = `${name}, welcome to JavaScript!`;
  return message;
}

console.log(greetings());
console.log(greetings("Guha Iyishvarya"));
```

```js
function generateFullName(firstName = "Sathish", lastName = "Sampath") {
  let space = " ";
  let fullName = firstName + space + lastName;
  return fullName;
}
...
console.log(generateFullName("Guha Iyishvarya", "Kotti"));
```
...
```js
const generateFullName = (firstName = "Sathish", lastName = "Sampath") => {
  let space = " ";
  let fullName = firstName + space + lastName;
  return fullName;
};
